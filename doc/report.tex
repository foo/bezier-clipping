...
Przykładem metody szukania wielu zer funkcji jest modyfikacja opisanej w poprzednim podrozdziale metody bisekcji. W przypadku metody szukania wielu zer mamy większą elastyczność, gdyż w przypadku gdy w obu połowach dzielonego przedziału jest możliwość wystąpienia zera, zamiast odrzucać jedną z połów obie połowy są określane jako potomkowie przedziału.
